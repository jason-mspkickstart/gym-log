...
export const PLAN = {
  d1: { name: "Day 1", sub: "Chest, Shoulders + Quads", lifts: [
    ...
    { name: "Skull Crushers", sets: 3, reps: "12", group: "B" },
    { name: "Standing Alt DB Curl", sets: 3, reps: "12", group: "B" },
  ] },
  d2: { name: "Day 2", sub: "Back, Biceps + Hinge", lifts: [
    ...
    { name: "Straight Arm Pulldown", sets: 3, reps: "12", group: "A" },
    { name: "Incline DB Curl", sets: 3, reps: "12", group: "A" },
    { name: "Barbell Shrugs", sets: 3, reps: "15", group: null },
  ] },
  d3: { name: "Day 3", sub: "Chest, Shoulders, Triceps", lifts: [
    ...
    { name: "Cable Lateral Raise", sets: 3, reps: "15", group: "A" },
    { name: "Reverse Grip Pushdown", sets: 3, reps: "12", group: "B" },
    { name: "Preacher Curl", sets: 3, reps: "12", group: "B" },
  ] },
  d4: { name: "Day 4", sub: "Back + Arms", lifts: [
    { name: "Lat Pulldown", sets: 4, reps: "10", group: null },
    { name: "Lawnmower Row", sets: 4, reps: "10", group: null },
    { name: "Seated Cable Row", sets: 3, reps: "12", group: "A" },
    { name: "Face Pull", sets: 3, reps: "15", group: "A" },
    { name: "Standing Alt DB Curl", sets: 3, reps: "12", group: "B" },
    { name: "Skull Crushers", sets: 3, reps: "12", group: "B" },
    { name: "Concentration Curl", sets: 3, reps: "12", group: "C" },
    { name: "Cable Pushdown", sets: 3, reps: "12", group: "C" },
  ] },
};
